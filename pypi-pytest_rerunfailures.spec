...
Version  : 11.1.2
Release  : 52
URL      : https://files.pythonhosted.org/packages/08/31/fb028a35b1d21086a4bea33a3b4b1f90304e5150d33c8d70a42fd10e4aff/pytest-rerunfailures-11.1.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/08/31/fb028a35b1d21086a4bea33a3b4b1f90304e5150d33c8d70a42fd10e4aff/pytest-rerunfailures-11.1.2.tar.gz
...
%prep
%setup -q -n pytest-rerunfailures-11.1.2
cd %{_builddir}/pytest-rerunfailures-11.1.2
pushd ..
cp -a pytest-rerunfailures-11.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678467127
