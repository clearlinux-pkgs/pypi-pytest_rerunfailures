...
Source0  : https://files.pythonhosted.org/packages/41/40/26684be329d127f0402144b731dea116e8bce27d0b04cd91e8e0bea4df4a/pytest-rerunfailures-13.0.tar.gz
...
%prep
%setup -q -n pytest-rerunfailures-13.0
cd %{_builddir}/pytest-rerunfailures-13.0
pushd ..
cp -a pytest-rerunfailures-13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701099234
