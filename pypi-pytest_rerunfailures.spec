...
Version  : 11.1.1
Release  : 51
URL      : https://files.pythonhosted.org/packages/46/a4/c6ddc065a558c7eda350552b121bc9bfa98d04d79f95a6efc4178225287f/pytest-rerunfailures-11.1.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/46/a4/c6ddc065a558c7eda350552b121bc9bfa98d04d79f95a6efc4178225287f/pytest-rerunfailures-11.1.1.tar.gz
...
%prep
%setup -q -n pytest-rerunfailures-11.1.1
cd %{_builddir}/pytest-rerunfailures-11.1.1
pushd ..
cp -a pytest-rerunfailures-11.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676655313
...
cp %{_builddir}/pytest-rerunfailures-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pytest_rerunfailures/7a5895d25709ec140bb6861ae0814cca5a834248 || :
