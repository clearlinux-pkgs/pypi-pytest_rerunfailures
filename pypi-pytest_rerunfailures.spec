...
Source0  : https://files.pythonhosted.org/packages/97/66/40f778791860c5234c5c677026d45c1a8708873b3dba8111de672bceac4f/pytest-rerunfailures-12.0.tar.gz
...
%prep
%setup -q -n pytest-rerunfailures-12.0
cd %{_builddir}/pytest-rerunfailures-12.0
pushd ..
cp -a pytest-rerunfailures-12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688572858
