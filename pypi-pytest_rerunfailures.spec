...
Version  : 11.0
Release  : 49
URL      : https://files.pythonhosted.org/packages/d8/cb/85f8f541ed805045b7a7603580681aa0c5d8ca8a5f87b7f30836db3e586e/pytest-rerunfailures-11.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/d8/cb/85f8f541ed805045b7a7603580681aa0c5d8ca8a5f87b7f30836db3e586e/pytest-rerunfailures-11.0.tar.gz
...
%prep
%setup -q -n pytest-rerunfailures-11.0
cd %{_builddir}/pytest-rerunfailures-11.0
pushd ..
cp -a pytest-rerunfailures-11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673540982
