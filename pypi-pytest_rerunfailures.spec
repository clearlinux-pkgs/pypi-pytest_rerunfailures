...
Source0  : https://files.pythonhosted.org/packages/cc/a4/6de45fe850759e94aa9a55cda807c76245af1941047294df26c851dfb4a9/pytest-rerunfailures-14.0.tar.gz
...
%prep
%setup -q -n pytest-rerunfailures-14.0
cd %{_builddir}/pytest-rerunfailures-14.0
pushd ..
cp -a pytest-rerunfailures-14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710541643
